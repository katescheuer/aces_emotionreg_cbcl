...
setwd("~/OneDrive - UW/ABCD/LAB_PROJECTS/Kate Schuer RBuddy Project")
...
ledata <- mh_y_le %>% 
  ...
  #'*So far my numbers are tracking with yours *
...
alldata <- genderdata %>%
  ...
  #'* I need to test these diff ways of joining!*
...
#'*something I should do to the whole data frame everytime I do analyses or graphing, but*
#'*then I wait until I have problems for a while, and it boils down to this lol*
...
#'*whoa I don't know if I've ever grouped by 2 variables!*
...
#'*this is so cool - I'll be doing this for now on*
...
#'*Ok I'm reminded I really need to use this map function*
#'
#'
variable_histograms <- 
...
#'*Wait, is it typical to run sign. tests for correlations? I always just thought*
#'*it was just a matrix, but not tested. Now I know otherwise!*
...
#'*someday I hope to be able to use loops like this, and understand* 
...
#'*Curious - why run anovas in addition to the Mixed model? Also did not* 
#'*know about this R squared function!*
