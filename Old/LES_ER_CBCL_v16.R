...
# '
gendertotalmodel <- ' # direct effect 
             totalCBCL~ c*LES + m*cisgirl + n*gd + p*age
           # mediator 
             DERS ~ a*LES  + q*cisgirl + r*gd + s*age
           # indirect effect 
             totalCBCL~ b*DERS
           # indirect effect w mediator (a*b)
             ab := a*b
...
'
gendertotalmodel <- ' # direct effect 
             totalCBCL~ c*LES + m*cisboy + n*gd + p*age
           # mediator 
             DERS ~ a*LES  + q*cisboy + r*gd + s*age
           # indirect effect 
             totalCBCL~ b*DERS
           # indirect effect w mediator (a*b)
             ab := a*b
...
lavTestLRT(nogendertotalfit,gender_constall_totalfit)
